...
| `MATLAB_Codes/Code1_Summer_Simulation_FINAL.m` | Main summer simulation at the final configuration (30 kg PCM per panel). Produces the hourly results, summary statistics, and Figures 4.1 to 4.6. Uses the heat transfer model of Sections 3.6 and 3.7. |
...
| `MATLAB_Codes/sensitivity_results.csv` | Output of Code 2, kept here because Code 1 reads it when drawing Figure 4.5. |
